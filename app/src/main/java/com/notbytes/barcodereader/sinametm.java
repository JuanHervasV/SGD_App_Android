...
public class sinametm extends AppCompatActivity implements View.OnClickListener, BarcodeReaderFragment.BarcodeReaderListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button:
                Intent i = new Intent(sinametm.this, Logeo.class);
                startActivity(i);
                break;
